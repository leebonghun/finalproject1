		...
		<div id="event-list-wrap" style="margin-top: 40px">
			...
			<div class="event-list mt15" >
				...
				<div class="contain" style="text-align: left;">
					<div class="tit" style="font-size: 20px; font-weight: bold;"> [이벤트 제목 : 카드 할인 행사] </div>
					<div class="con" style="font-size: 20px; font-weight: bold;"> [이벤트 내용 : 신한, 우리, 국민카드로 영화 예매 결제 시 영화 티켓 가격의 5% 할인혜택] </div>
					<div class="hum" style="font-size: 20px; font-weight: bold;"> [이벤트 대상 : 신한,우리,국민 카드 사용자] </div>
					<div class="date" style="font-size: 20px; font-weight: bold;"> [이벤트 기간 : 2022.01.01 ~ 2022.12.31] </div>
				</div>
				</div>
