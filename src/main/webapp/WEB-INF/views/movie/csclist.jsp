				...
				<div class="panel-group w3l_panel_group_faq" id="accordion"
					...
					<div class="panel panel-default">
						...
						<div id="collapseOne" class="panel-collapse collapse in"
							...
							<div class="panel-body panel_text">분실물은 본점의 안내데스크에서도 문의가 가능하며 또한 해당 게시판을 통하여 문의하실 수 있습니다.
							분실물은 최대 7일동안 보관하며 아무 문의가 없는 경우 7일후 파기되며 본사는 이에 아무 책임이 없음을 알려드립니다. 
							  </div>
						</div>
					</div>
					<div class="panel panel-default">
						...
						<div id="collapseTwo" class="panel-collapse collapse"
							...
							고객센터에 대관일,관람할 영화,관람인원,이름,연락처,이메일을 적어 글을 남겨주시면
							하루안에 답변해드립니다.혹은 고객 센터 전화서비스를 통하여 문의 하실수도 있습니다.
							고객센터:02-1234-5678
							</div>
						</div>
					</div>
