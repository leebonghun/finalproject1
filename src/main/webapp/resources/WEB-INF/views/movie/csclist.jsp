                  ...
                  <div id="collapseTwo" class="panel-collapse collapse"
                     ...
                     <div class="panel-body panel_text">
                        ...
                        <ol style="list-style-type: decimal" start="1">
                           ...
                           <li>공간의 장비 및 시설물 파손 시 그에 대한 배상 책임이 있습니다.</li>
                           <li>대관료는 계약체결 후 대관일 이틀 전까지 입금 또는 결제하여야 합니다.</li>
                           <li>6시간 이상 대관 혹은 종일 대관시 별도의 금액을 책정합니다.</li>
                        </ol>

                        단체 관림 및 대관문의를 원하시는 경우 고객센터에 대관일,관람할 영화,관람인원,이름,연락처,이메일을 적어 글을
                        남겨주시면 하루안에 답변해드립니다.혹은 고객 센터 전화서비스를 통하여 문의 하실수도 있습니다.
                  ...
                  <div id="collapseThree" class="panel-collapse collapse"
                     ...
                     <div class="panel-body panel_text">
                        ...
                        <ol style="list-style-type: decimal" start="1">
                           ...
                           <li>결제방식 선택 후 결제를 완료하면, 예매확인을 통해 예약된 내역을 확인합니다.</li>
                        </ol>
                        예매취소 및 환불안내
                        <hr>
                        <ol style="list-style-type: decimal" start="1">
